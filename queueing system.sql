...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2024 at 06:43 AM
...
(1, 'SCS001', 'GUEST', 'SCS', 'Marlon Diloy', 'kiosk', '2024-06-15 04:32:08', NULL, 'Subject Registration', NULL, 0);
...
INSERT INTO `academics_logs` (`id`, `queue_number`, `student_id`, `endorsed_from`, `endorsed_to`, `timestamp`, `timeout`, `remarks`, `transaction`, `status`) VALUES
(1, 'SCS001', 'GUEST', 'KIOSK', 'ACCOUNTING', '2024-06-15 04:32:08', '2024-06-15 04:42:27', 'Testttt', 'Payment', NULL);
...
CREATE TABLE `academics_queue` (
  ...
  `availability` int(255) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'SCS001', 'GUEST', '2024-06-15 04:42:27', 'ACADEMICS', 'Payment', 'Testttt', 0, 0, '', NULL);
...
(1, 'Vincent Rivera', 'SCS', 'offline', 0, 'BSCS'),
(2, 'Marlon Diloy', 'SCS', 'available', 0, 'BSIT_BSIS'),
...
(14, 'Richard Miguel Butial', 'SHS', 'available', 0, 'ABM'),
(15, 'Jhanna Mae Tadique', 'SHS', 'available', 0, 'STEM'),
...
(1, 'GUEST', 'SCS001', 'ACADEMICS', '-', '2024-06-15 04:32:08', 0, NULL, 'kiosk');
...
INSERT INTO `queue_logs` (`id`, `student_id`, `queue_number`, `office`, `timestamp`, `status`, `remarks`, `endorsed`) VALUES
(1, 'GUEST', 'SCS001', 'Kiosk', '2024-06-15 04:32:08', 0, NULL, 'ACADEMICS'),
(2, 'GUEST', 'SCS001', 'ACADEMICS', '2024-06-15 04:42:27', 0, 'Testttt', 'ACCOUNTING');
...
(2, 'Marlon Diloy', 'SCS', 'marlondiloy', '25d55ad283aa400af464c76d713c07ad', 'available', 0),
...
(25, 'Christian Avestro', 'GUIDANCE', 'christian', '12345678', NULL, 1),
(26, 'Alia Micosa', 'CLINIC', 'alia', '12345678', NULL, 1),
(27, 'Aubrey Esperanza', 'ITSO', 'aubrey', '12345678', NULL, 1),
(28, 'Aira Paras', 'ASSETS', 'aira', '12345678', NULL, 1),
(29, 'hello', 'ACCOUNTING', 'seji', '12345678', 'offline', 1),
(30, 'hello1', 'ADMISSION', 'anton', '12345678', NULL, 1),
(31, 'Arturo Antonio Arceo', 'ADMISSION', 'Anton', '12345678', NULL, 0);
