    ...
    $selectedEndorsedFrom = $rowFetchEndorsedFrom['endorsed_from'];
     ...
     if ($conn->query($sqlInsertIntoAccountingLogs) === TRUE) {
         ...
         $sqlInsertIntoQueueLogs = "INSERT INTO queue_logs (queue_number, student_id, office, remarks, endorsed) 
             VALUES ('$selectedQueueNumber', '$selectedStudentID', 'Clinic', '$selectedRemarks', '$selectedOffice')";
...
<body>
    ...
    <div id="center" class="center-content">
        ...
        <button style="margin-left: 2%;" class="button" type="button" onclick="openEndorsementPopup()"
            id="endorseButton" disabled><i class="fa fa-paper-plane"></i> ENDORSE</button>
